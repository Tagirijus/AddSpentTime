<div class="page-header">
    <h2><?= t('Change estimated time') ?></h2>
</div>
<form method="post" action="<?= $this->url->href('AddSpentTimeController', 'changeEstimatedTime', ['plugin' => 'AddSpentTime', 'task_id' => $task['id'], 'project_id' => $task['project_id']]) ?>" autocomplete="off">
    <?= $this->form->csrf() ?>
    ...
    <div class="task-form-container">
        ...
        <div class="task-form-main-column">
            ...
            <p style="font-style: italic; font-size: .75em; opacity: .75; margin-top: 1em;">
                <?= t('Enter time to add ("0.5" for hours, "0:30" for hours and minutes, "30" for only minutes, negative numbers work as well)') ?>
            </p>
        </div>
